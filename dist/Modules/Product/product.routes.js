...
router.post("/create", (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.user), productController_1.productController.createProduct);
router.post("/update", (0, auth_1.default)(client_1.UserRole.admin, client_1.UserRole.user), productController_1.productController.getSingleProductUpdate);
